...
- Envio de lembretes/cobranças ao cliente final dentro dos limites configurados (canal inicial: **a definir na Fase 003**; hipótese padrão: e-mail);
...
**Plataforma:**
- Múltiplos tenants em produção / self-service de onboarding;
...
- Automação de WhatsApp no piloto (**hipótese**: canal inicial é e-mail; WhatsApp exige análise de custo/política da plataforma — decisão da Fase 003);
...
|---|---|---|
| 1 | Canal inicial de comunicação (e-mail vs. WhatsApp) | Fase 003 (ADR) + entrevistas |
| 2 | Como receber documentos de volta com segurança | Fase 003 (ADR) |
